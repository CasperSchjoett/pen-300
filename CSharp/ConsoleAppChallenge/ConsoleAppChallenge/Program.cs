...
namespace ConsoleAppChallenge
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			Process targetProcess = Process.GetProcessesByName("svchost")[0];
